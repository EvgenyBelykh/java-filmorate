...
public class DaoFilmControllerTest {
    ...
    public void getMostPopularFilmByRateTest() {
        ...
        filmStorage.addRateFromUserById(2, 1, 2);
        filmStorage.addRateFromUserById(2, 2, 3);
        filmStorage.addRateFromUserById(2, 3, 4);

        filmStorage.addRateFromUserById(3, 1, 10);
        filmStorage.addRateFromUserById(3, 2, 9);
   ...
   @Test
    public void getSortedFilmByDirectorTest() {
       ...
       filmStorage.addRateFromUserById(1, 1, 5);
        ...
        assertEquals(filmStorage.getSortedFilmByDirector(1, "rates"), List.of(filmStorage.getFilmById(3),
                filmStorage.getFilmById(1), filmStorage.getFilmById(2)));
